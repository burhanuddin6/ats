# Generated by Django 4.2.1 on 2023-07-10 16:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('URL', models.CharField(max_length=128, validators=[applicants.models.OptionalSchemeURLValidator()], verbose_name='Platform URL')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('national_ID', models.CharField(db_index=True, max_length=13, verbose_name='National ID Card Number For Pakistan (eg. 4210167890123)')),
                ('phone', models.CharField(db_index=True, max_length=11, verbose_name='Phone Number. Pakistan format without hyphens (e.g. 03001234567))')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_Name', models.CharField(max_length=64)),
                ('last_Name', models.CharField(max_length=64)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='recruiter', to=settings.AUTH_USER_MODEL, validators=[applicants.models.is_recruiter])),
            ],
        ),
        migrations.CreateModel(
            name='Skill',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_URL', models.CharField(max_length=128, validators=[applicants.models.OptionalSchemeURLValidator()], verbose_name='LinkedIn Profile URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(max_length=1024, verbose_name='Job Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slot_group_ID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='slots', to='applicants.interview_daily_timeframe', verbose_name='Group of the slot')),
            ],
        ),
        migrations.AddField(
            model_name='interview_daily_timeframe',
            name='slot_Group_ID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='weekly_timeframes', to='applicants.slot_group', verbose_name='Slot Group'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidate_ID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='candidate_interviews', to='applicants.candidate')),
                ('interview_Slot_ID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='candidate_interviews', to='applicants.interview_slot')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.CASCADE, related_name='candidate_application', to='applicants.education')),
                ('experience', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.CASCADE, related_name='candidate_application', to='applicants.experience')),
                ('profile', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.CASCADE, related_name='candidate_application', to='applicants.profile')),
                ('reference', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.CASCADE, related_name='candidate_application', to='applicants.reference')),
                ('skills', models.ManyToManyField(related_name='candidate_application', to='applicants.skill')),
                ('application_ID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='candidate_applications', to='applicants.application')),
            ],
        ),
    ]
